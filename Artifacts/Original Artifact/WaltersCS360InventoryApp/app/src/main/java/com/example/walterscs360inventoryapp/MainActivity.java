...
public class MainActivity extends AppCompatActivity {
    ...
    private static int stockWarningAmt = 5;
    ...
    private void addItem() {
        ...
        if (db.addItem(id, name, amount, currentUser)) {
            clearEntries();
            loadItems();
            checkStock();
    ...
    private void loadItems() {
        ...
        ArrayList<String[]> items= db.getItems(currentUser);
    ...
    private void addItemRow(String id, String name, int amount) {
        ...
        row.setOnClickListener(v -> editItemQty(id, name, amount));
        deleteBtn.setOnClickListener(v -> {
            if (db.deleteItem(id, currentUser)) {
    ...
    private void editItemQty(String id, String name, int currAmt) {
        ...
        builder.setPositiveButton("Update Qty", (dialog, which) -> {
            ...
            try {
                ...
                if (db.updateItem(id, name, newAmount, currentUser)) {
    ...
    private void checkStock() {
        ...
        ArrayList<String[]> lowStockItems = db.getLowStockItems(currentUser, stockWarningAmt);
