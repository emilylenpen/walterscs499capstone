...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean addItem(String itemId, String name, int amount, int userId) {
    ...
    public boolean updateItem(String itemId, String name, int amount, int userId) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put("name", name);
        values.put("amount", amount);
    ...
    public ArrayList<String[]> getLowStockItems(int userId, int lowStockValue) {
        ...
        ArrayList<String[]> items = new ArrayList<>();
        Cursor cursor = db.rawQuery(
                "SELECT name, amount FROM inventory WHERE user_id=? AND amount<?",
